...
* [Android Window에 대해 공부하기](#android-window에-대해-공부하기)
  ...
  * [CutOut](#cutout)
    * [🧾앱에서 Coutout을 처리하는 방법](#앱에서-coutout을-처리하는-방법)
      * [🤔어떤 옵션이 있고, 어떻게 적용할까?](#어떤-옵션이-있고-어떻게-적용할까)
      * [🤔 Default Behavior](#-default-behavior)
    * [🧾Coutout 적용 결과](#coutout-적용-결과)
      * [🤔 근데 왜 Cutout을 onResume 이후에 호출하면 적용이 안될까?](#-근데-왜-cutout을-onresume-이후에-호출하면-적용이-안될까-)
      * [✅ 정리 Cutout 적용 방법](#-정리-cutout-적용-방법)
  * [참고 자료](#참고-자료)
    * [공식문서](#공식문서)
    * [유튜브](#유튜브)
    * [블로그](#블로그)
